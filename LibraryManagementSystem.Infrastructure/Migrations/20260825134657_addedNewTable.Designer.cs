...
namespace LibraryManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260825134657_addedNewTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSystem.Domain.Entity.Reservation", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LibraryManagementSystem.Domain.Entity.Reservation", b =>
                {
                    b.HasOne("LibraryManagementSystem.Domain.Entity.Member", "members")
                        .WithMany("reservation")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementSystem.Domain.Entity.Book", "books")
                        .WithMany("reservation")
                        .HasForeignKey("bookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
